...
4. Append one line to website/assets/art/raw/manifest.md: `v7-01-hero-p.png | <original path> | <retry note or none>`.

Retry transient errors. Finish with the line IMAGE v7-01-hero-p DONE.
