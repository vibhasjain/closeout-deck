...
(() => {
  ...
  window.CLAIMS = {
    ...
    'pricing-per-pay': entry('Priced per pay run, not per shift.', 'unconfirmed', 'Eighth website change batch; CEO feedback; confirm pricing unit before publication'),
    'pricing': entry('Contracts from $10k a year; paid pilots available', 'provided'),
    ...
    'clipboard-read': entry('IMG_2041; 4 rows read; in 08:58; break 30 min; out written as 17:00', 'synthetic', 'Sixth website change batch; synthetic demonstration data'),
    ...
    'report-validation': metric('94% by month 11, from 64% at go-live', '#numbers visibility after go-live'),
