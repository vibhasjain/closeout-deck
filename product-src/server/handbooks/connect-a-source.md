...
- Open /settings?tab=sources to review sources and their connection status.
- A source supplies time entries; a destination receives a Payroll run.
- Connection methods depend on the source: browser, API, forwarding or upload.
- Browser connection currently demonstrates sign-in and read-only access.
