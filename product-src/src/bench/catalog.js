...
"bucket": "Legal",
"juris": "US",
"statement": "Overtime is 1.5x the regular rate, not the base rate \u2014 night and weekend differentials, attendance bonuses, and any promised production bonus must be folded in (total remuneration / total hours) before applying the OT premium",
...
"bucket": "Legal",
"juris": "US",
"statement": "Home-to-work commute is unpaid; travel between job sites during work hours is paid time and counts toward overtime; travel to a farther-than-usual site is paid for the extra time",
...
{
"id": "PACK-10",
"name": "Donning/doffing and pre/post-work time",
"bucket": "Legal",
"juris": "US",
...
"params": "Per-site fixed allowance (min/day) added before first punch / after last punch",
"src": [
...
"statement": "On a 24h+ stretch of work, you may exclude up to 8h of scheduled sleep by agreement \u2014 but only with adequate facilities; interruptions are paid, and if the worker can't get at least 5 consecutive hours of sleep the whole period is paid",
"det": "Yes \u2014 thresholds encode; interruption minutes come from call logs/attestation",
"params": "Max exclusion=8h; min uninterrupted sleep=5h; agreement-on-file flag; length trigger=24h",
"src": [
...
"bucket": "State",
"juris": "New York",
"statement": "'Manual workers' (>25% physical labor \u2014 most warehouse and hospitality workers) must be paid weekly, within 7 calendar days of the end of the week the wages were earned (Labor Law \u00a7191)",
...
"bucket": "State",
"juris": "Colorado",
"statement": "1.5x after 12 hours in a workday, after 12 consecutive hours regardless of breaks between time entries, or after 40 in the week \u2014 whichever yields more pay",
"det": "Yes \u2014 three parallel computations, take max",
"params": "Daily threshold=12h; consecutive threshold=12h (crosses time entries); weekly=40h; multiplier=1.5x; pick-greatest rule",
"src": [
...
"statement": "Massachusetts owes 3 hours at minimum wage if 3h+ of scheduled work is cut short; New Hampshire owes 2 hours at the regular rate; Connecticut owes 2\u20134 hours depending on industry; several states have none \u2014 table it by state",
...
"statement": "Pay the highest of federal, state, and city/county minimum wage for where the work was actually done \u2014 Seattle $21.30, Denver $19.29, West Hollywood $20.25 (2026); ~49 localities changed rates on Jan 1 alone, so the rate table is per-geofence, per-date",
...
"statement": "14 days' schedule notice; adding 30+ minutes to a schedule owes one extra hour; the worker gets a 10-hour rest window between closing and opening paid at 1.5x if worked",
...
"bucket": "Contract",
"juris": "Per-contract",
"statement": "Every position on the work order has its own bill rate; bill rate = pay rate \u00d7 (1 + markup), with markups typically 25\u201375% \u2014 validation means every time entry's hours price out at the right position's rate for both payout and invoice",
...
"statement": "Overtime and holidays are billed at 1.5x the hourly bill rate for hours over 40 in a standard Monday to Sunday week; 'holiday' is an enumerated list (Easter, Memorial Day, July 4th, Labor Day, Thanksgiving, Christmas, NYE, New Year's Day, MLK Day, Juneteenth in LGC's contract)",
"det": "Yes \u2014 same OT math applied to bill rate, plus a holiday calendar",
"params": "Billing OT multiplier=1.5x; workweek=Mon to Sun; named-holiday list per contract",
"src": [
"https://lgcassociates.com/wp-content/uploads/2023/04/LGC-Staffing-Services-Agreement-July-2021.pdf"
]
},
...
"det": "Yes \u2014 timestamp of cancellation vs scheduled start",
...
{
"id": "PACK-43",
"name": "CBA night and weekend differentials",
"bucket": "CBA",
"juris": "Per-CBA",
...
"params": "Window definitions (e.g., 6:00 PM to 6:00 AM, Sat/Sun); rate=flat $/hr or % uplift; interaction=include in regular rate",
"src": [
...
"bucket": "CBA",
"juris": "Per-CBA",
"statement": "Union contracts commonly guarantee minimum daily hours (e.g., 4-hour show-up guarantee) or weekly hours \u2014 reported hours below the guarantee is topped up to the guaranteed amount at the regular rate",
...
"statement": "Multiple workers punching at the exact same second on a shared device, or several time entries with identical hours all period, points to one person punching for the group \u2014 cluster-flag simultaneous punches and duplicate-hour groups",
"det": "Yes \u2014 grouping/equality tests on punch streams",
"params": "Simultaneity window=0\u20132s on same device; duplicate-group size threshold (\u22653 identical time entries); device ID correlation",
"src": [
...
"bucket": "Common sense",
"juris": "Universal ops heuristic",
"statement": "Routine overtime with no prior approval, chronic clock-ins well before the site opens, or hours consistently pinned at the plan's maximum are the top audit red flags \u2014 compare worked vs scheduled on every time entry and route variance over the threshold to a supervisor before pay",
