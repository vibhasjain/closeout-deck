...
export function Profile() {
  ...
  return <div className="payroll-profile-page">
    <PageTitle title="Profile" description="What your Closeout Agent reads before every pay run." right={<button type="button" className="btn" onClick={() => setRulebook(true)}>View Rulebook</button>} />
